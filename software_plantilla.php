    ...
    <nav class="navbar navbar-default" role="navigation">
        ...
        <!-- /.container -->
                ...
                <?php
                    ...
                    $id = $_GET['id'];
                    $resultado=$link->query("SELECT * FROM `enlace_software` WHERE `enlace_software_id`='$id'");
                    ...
                    <link href='http://fonts.googleapis.com/css?family=Raleway:500' rel='stylesheet' type='text/css'>
                        ...
                        <div class="panel panel-info">
                          <div class="panel-heading">
                            <h3 class="panel-title"><?php printf ("%s\n", $row["PROGRAMA"]);?></h3>
                          </div>
                          ...
                          <div class="row"> 
                            <fieldset>
                                 <?php
                                  ...
                                  ?>
                                <h2 class="intro-text text-center">Descripcion: <?php printf ("%s\n", $row["DESCRIPCION"]);?></h2>
                                <form method="post">
                                <button id="descarga" name="descarga" class="btn btn-primary">Descargar</button>
                                </form>
                            </fieldset>                           
                        </div>
